    ...
    let statistics = match &args {
        &Opt::Encode {level, ref ipath, ref opath} => {
            encode(
                ...
                &mut get_ofile(opath)?,
                &match level {
                    0 => LZCfg {match_depth:  3, lazy_match_depth1: 1, lazy_match_depth2: 1},
                    1 => LZCfg {match_depth:  5, lazy_match_depth1: 2, lazy_match_depth2: 1},
                    2 => LZCfg {match_depth:  8, lazy_match_depth1: 3, lazy_match_depth2: 2},
                    3 => LZCfg {match_depth: 13, lazy_match_depth1: 5, lazy_match_depth2: 3},
                    4 => LZCfg {match_depth: 21, lazy_match_depth1: 8, lazy_match_depth2: 5},
