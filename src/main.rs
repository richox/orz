...
pub fn parse_args() -> Result<Argument, String> {
    ...
    return Ok(Argument {
        mode: match args_mode.as_str() {
            "e0" => Mode::Encode(
               LZCfg {match_depth:  2, lazy_match_depth1: 1, match_depth_lazy2: 1}),
            "e1" => Mode::Encode(
               LZCfg {match_depth:  3, lazy_match_depth1: 2, match_depth_lazy2: 1}),
            "e2" => Mode::Encode(
               LZCfg {match_depth:  5, lazy_match_depth1: 3, match_depth_lazy2: 2}),
            "e3" => Mode::Encode(
               LZCfg {match_depth:  8, lazy_match_depth1: 5, match_depth_lazy2: 3}),
            "e4" => Mode::Encode(
               LZCfg {match_depth: 13, lazy_match_depth1: 8, match_depth_lazy2: 5}),
            "d"  => Mode::Decode,
